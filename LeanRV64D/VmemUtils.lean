...
/-- Type quantifiers: k_ex826885_ : Bool, width : Nat, width ∈ {1, 2, 4, 8} -/
...
/-- Type quantifiers: k_ex826899_ : Bool, k_ex826898_ : Bool, k_ex826897_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex826931_ : Bool, k_ex826930_ : Bool, k_ex826929_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex826978_ : Bool, k_ex826977_ : Bool, k_ex826976_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex826988_ : Bool, k_ex826987_ : Bool, k_ex826986_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
