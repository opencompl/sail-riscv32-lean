...
/-- Type quantifiers: k_ex828573_ : Bool, level : Nat, k_ex828571_ : Bool, k_ex828570_ : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex828644_ : Bool, k_ex828643_ : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex828675_ : Bool, k_ex828674_ : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex828710_ : Bool, k_ex828709_ : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
