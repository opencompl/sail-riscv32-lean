...
/-- Type quantifiers: k_ex930492_ : Bool -/
...
/-- Type quantifiers: k_ex930498_ : Bool, k_ex930497_ : Bool, k_ex930496_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex930506_ : Bool, k_ex930505_ : Bool, k_ex930504_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex930515_ : Bool, k_ex930514_ : Bool, k_ex930513_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex930523_ : Bool, k_ex930522_ : Bool, k_ex930521_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
