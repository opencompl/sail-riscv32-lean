...
/-- Type quantifiers: k_ex1154415_ : Bool -/
...
/-- Type quantifiers: k_ex1155797_ : Bool, width : Nat, width ∈ {1, 2, 4, 8} -/
...
def plat_sig_base : physaddrbits := unwrapValue ((to_bits_checked (l := 34) (201326592 : Int)))
